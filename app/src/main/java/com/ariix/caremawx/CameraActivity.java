...
import com.ariix.caremawx.carema.CameraManager;
import com.ariix.caremawx.carema.CameraProgressBar;
import com.ariix.caremawx.carema.CameraView;
import com.ariix.caremawx.carema.MediaPlayerManager;
import com.ariix.caremawx.utils.FileUtils;
...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        mProgressbar.setOnProgressTouchListener(new CameraProgressBar.OnProgressTouchListener() {
            ...
            public void onLongClickUp(CameraProgressBar progressBar) {
                ...
                if (recordSecond < MIN_RECORD_TIME) {//小于最小录制时间作废
                    ...
                    Log.d("CameraActivity", "视频存储在..." + recorderPath);
                    Toast.makeText(mContext, "视频存储在..." + recorderPath, Toast.LENGTH_LONG).show();
    ...
    private void openCamera(SurfaceTexture texture, int width, int height) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(mContext, "开启相机没有权限...", Toast.LENGTH_SHORT).show();
        }
    }
